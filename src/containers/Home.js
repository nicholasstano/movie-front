    ...
    render() {
        return (
            <div className="mediaContainer">
                <h1 className="homeHeader font-weight-light">Hello! My name is Nick and I enjoy revisiting media.</h1>
                <div className="homeFavoriteSix">
                    {this.state.hoverAlbums ?
                        <div className="homeFavoriteMedia font-weight-light"><p>Computerwelt</p><img src={photos.albums[0]} alt="computerwelt" onMouseEnter={this.onMouseAlbumsEnterHandler} /></div>
                        :
                    ...
                    {this.state.hoverBoardGames ?
                        <div className="homeFavoriteMedia font-weight-light"><p>Terra Mystica</p><img src={photos.boardGames[0]} alt="terramystica" onMouseEnter={this.onMouseBoardGamesEnterHandler} /></div>
                        :
                    ...
                    {this.state.hoverBooks ?
                        <div className="homeFavoriteMedia font-weight-light"><p>Order of the Phoenix</p><img src={photos.books[0]} alt="orderofthephoenix" onMouseEnter={this.onMouseBooksEnterHandler} /></div>
                        :
                    ...
                    {this.state.hoverMovies ?
                        <div className="homeFavoriteMedia font-weight-light"><p>Pulp Fiction</p><img src={photos.movies[0]} alt="pulpfiction" onMouseEnter={this.onMouseMoviesEnterHandler} /></div>
                        :
                    ...
                    {this.state.hoverTVShows ?
                        <div className="homeFavoriteMedia font-weight-light"><p>Whose Line Is It Anyway?</p><img src={photos.tvShows[0]} alt="whoseline" onMouseEnter={this.onMouseTVShowsEnterHandler} /></div>
                        :
                    ...
                    {this.state.hoverVideoGames ?
                        <div className="homeFavoriteMedia font-weight-light"><p>Warcraft 3: The Frozen Throne</p><img src={photos.videoGames[0]} alt="warcraft3tft" onMouseEnter={this.onMouseVideoGamesEnterHandler} /></div>
                        :
