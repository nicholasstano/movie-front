...
export class Home extends Component {
    render() {
        return (
            <div>
                <p className="homeHeader">Hello there! We are in a day and age where there is so much media out there. While continuing to discover new music, movies, books, and games I definitely find myself revisiting my favorites. I have reread the Harry Potter franchise, listened to Trans Europa Express, rewatched Spider-man: Homecoming, and played through Starcraft too many times.</p>
