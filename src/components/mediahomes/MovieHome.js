...
export default function MovieHome() {
    ...
    return (
        <div className="mediaHome">
            ...
            <p>1950's rewatch watchlist: In a Lonely Place, Rashomon, Strangers on a Train, Dial M for Murder, Rear Window, Seven Samurai, The Night of the Hunter, The Searchers, 12 Angry Men, The Hidden Fortress, Touch of Evil, Vertigo, North by Northwest</p>
