...
import whoselineisitanyway1 from './whoselineisitanyway1.jpeg'
...
const exportedTVShowsPosts = { 
    ...
    entourage7, 
    entourage8, 
    flightoftheconchords1, 
    flightoftheconchords2, 
    agentcarter1, 
    dragonballzkai1, 
    dragonballsuper1, 
    dragonballzkai2, 
    ...
    shaqlife, 
    themandalorian1, 
    whoselineisitanywayaisha, 
    thebestofwhoselineisitanyway, 
    whoselineisitanyway1, 
    whoselineisitanyway2, 
    entourage1, 
    whoselineisitanyway14, 
